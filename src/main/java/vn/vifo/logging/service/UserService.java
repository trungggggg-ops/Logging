...
import vn.vifo.logging.dto.request.auth.RegisterRequest;
import vn.vifo.logging.dto.request.auth.ResetPasswordRequest;
import vn.vifo.logging.dto.request.user.AbstractBaseCreateUserRequest;
import vn.vifo.logging.dto.request.user.AbstractBaseUpdateUserRequest;
import vn.vifo.logging.dto.request.user.CreateUserRequest;
import vn.vifo.logging.dto.request.user.UpdatePasswordRequest;
import vn.vifo.logging.dto.request.user.UpdateUserRequest;
import vn.vifo.logging.entity.User;
import vn.vifo.logging.entity.specification.UserFilterSpecification;
import vn.vifo.logging.entity.specification.criteria.PaginationCriteria;
import vn.vifo.logging.entity.specification.criteria.UserCriteria;
import vn.vifo.logging.event.UserEmailVerificationSendEvent;
import vn.vifo.logging.event.UserPasswordResetSendEvent;
import vn.vifo.logging.exception.BadRequestException;
import vn.vifo.logging.exception.NotFoundException;
import vn.vifo.logging.repository.UserRepository;
import vn.vifo.logging.security.JwtUserDetails;
